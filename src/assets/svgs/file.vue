<template lang="pug">
  svg(xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" transform="translate(0 -2.5)" x="0px" y="0px" viewBox="0 0 279.578 266.577" style="enable-background:new 0 0 279.578 266.577;" xml:space="preserve")
    g
      g
